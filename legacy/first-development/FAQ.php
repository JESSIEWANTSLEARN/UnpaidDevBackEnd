...
<body class="min-h-screen flex">
    ...
    <aside class="w-64 bg-[#2C3E50] text-white flex-shrink-0 min-h-screen hidden md:flex flex-col">
            ...
            <!-- Logout -->
            <div class="h-[82px] flex items-center px-7 border-t border-white/10">
    ...
    <section class="flex-1 min-w-0">
                    ...
                    <div class="mb-7">
                        <div>
                            ...
                            <p class="mt-2 max-w-3xl text-sm leading-6 text-[#374151]">
                                Find answers to common questions about inventory, customer orders, purchase orders, suppliers, and product availability in the Walang Brown Out system.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <!-- Footer -->
            <footer class="h-[82px] flex items-center justify-center border-t border-[#E5E7EB] bg-[#FFFFFF] px-6">
